        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Project Readiness Resources
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
              Access comprehensive project readiness documents and frameworks for developing high-quality, GCF-compliant projects and programmes
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 max-w-2xl">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search project readiness documents..."
                value={searchTerm}
          ...
          {loading && (
            <div className="text-center py-20">
              ...
              <p className="mt-6 font-body text-xl text-text-secondary font-medium">
                Loading project readiness documents...
              </p>
            </div>
          )}
              ...
              {filteredDocuments.length === 0 ? (
                <div className="text-center py-20">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-primary mb-3">
                    {searchTerm ? 'No Matching Documents' : 'No Project Readiness Documents'}
                  </h3>
                  <p className="font-body text-lg text-text-secondary">
                    {searchTerm
                      ? 'Try adjusting your search terms'
                      : 'No project readiness documents have been uploaded yet. Check back later!'}
                  </p>
                </div>
              ) : (
