...
const Navigation = () => {
  ...
  const readinessEritreaLinks = [    { path: '/workshops', label: 'Workshops' },
  ...
  return (
    <nav className="bg-primary shadow-md fixed top-0 left-0 right-0 z-50">
      ...
      <div
        ...
        className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden bg-primary-dark max-h-[calc(100vh-4rem)] overflow-y-auto`}
      >
